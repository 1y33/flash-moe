...
UTILS     = csrc/utils/dtypes.cuh csrc/utils/warp.cuh csrc/utils/allocator.cuh
...
$(BUILD_DIR)/test_kernel: tests/test_kernel.cu csrc/kernel.cu csrc/os.cu csrc/worker.cu csrc/queue.cu csrc/flashmoe.cuh csrc/utils/allocator.cuh csrc/tasks/executor.cuh csrc/tasks/gemv.cuh csrc/tasks/silu_mul.cuh csrc/tasks/softmax_topk.cuh $(UTILS) | $(BUILD_DIR)
	$(NVCC) $(ARCH) -o $@ $<
